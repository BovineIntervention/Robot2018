 ...
 */
public class PowerUpJoystick extends JoystickControlsBase 
{
    private static JoystickControlsBase mInstance = new PowerUpJoystick();
...
//	    boolean squaredInputs = true;	// set to true to increase fine control while permitting full power
	    ...
	    boolean reverseButton  = mStick.getRawButton(Constants.kXboxRTriggerAxis);
