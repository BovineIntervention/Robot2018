...
public class CenterStartToLeftScaleMode extends AutoModeBase {
	FieldDimensions fieldDimensions;
	Path pathToSwitch;
	Path pathBackupFromSwitch;
	
	
    public CenterStartToLeftScaleMode() 
    {
    ...
    private void init()
    {
		...
		//get where to turn
		Vector2d scaleTurnPosition = new Vector2d(scaleStopPosition.getX()-fieldDimensions.kSwitchTurnPositionOffsetX, scaleStopPosition.getY());
