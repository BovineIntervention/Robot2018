...
public class OtherStartToLeftScaleMode extends AutoModeBase {
	FieldDimensions fieldDimensions;
	Path pathToSwitch;
	Path pathBackupFromSwitch;
	
	
    public OtherStartToLeftScaleMode() 
    {
    ...
    private void init()
    {
		...
		pathToSwitch.add(new Waypoint(powerCubePosition, visionOptions));
