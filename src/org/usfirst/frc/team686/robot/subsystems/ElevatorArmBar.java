...
public class ElevatorArmBar extends Subsystem {
	...
	public enum ElevatorArmBarState 
	{
		...
		DRIVE(			Constants.kCubeGroundHeight, 		Constants.kArmBarDownAngleDeg, 	Constants.kArmBarFlatAngleDeg),
		EXCHANGE(		Constants.kCubeGroundHeight, 		Constants.kArmBarDownAngleDeg, 	Constants.kArmBarDownAngleDeg),
		SWITCH(			Constants.kCubeGroundHeight, 		Constants.kArmBarUpAngleDeg, 	Constants.kArmBarFlatAngleDeg),
		SCALE_LOW(		Constants.kCubeGroundHeight, 		Constants.kArmBarUpAngleDeg, 	Constants.kArmBarFlatAngleDeg),
		SCALE_MED(		Constants.kCubeGroundHeight, 		Constants.kArmBarUpAngleDeg, 	Constants.kArmBarFlatAngleDeg),
		SCALE_HIGH(		Constants.kCubeGroundHeight, 		Constants.kArmBarUpAngleDeg, 	Constants.kArmBarFlatAngleDeg);
	...
	private void set(ElevatorArmBarState _newState, boolean _extended)
	{
		...
		else
		{
			...
			double elevatorHeight = calcElevatorHeight(state.bottomOfCubeHeight,    Constants.kArmBarFlatAngleDeg);
