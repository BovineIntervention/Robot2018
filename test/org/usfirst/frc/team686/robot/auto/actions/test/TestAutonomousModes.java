...
import org.usfirst.frc.team686.robot.auto.actions.test.FakeGyro;
...
import org.usfirst.frc.team686.robot.lib.util.MyTimer.TimestampMode;
...
//import org.usfirst.frc.team686.robot.loops.GoalStateLoop;
...
public class TestAutonomousModes
{
	...
	public void testAutonomous()
	{
		...
		autoModeExecuter.setAutoMode( new DriveStraightMode(48,false) );
...
//		imageTimestamp    	  = visionStatus.getImageCaptureTimestamp();
		...
		// Process
		//---------------------------------------------------
		WheelSpeed wheelSpeed = driveCtrl.pathVisionDrive(currentTime, currentPose, previousPose, 0, normalizedTargetX, normalizedTargetWidth);	// sets speed, curvature to follow path
